...
namespace Arcade.Compose
{
    ...
    ""controlSchemes"": []
        ...
        ~@AdeInputControl()
        {
            Debug.Assert(!m_ArcadeHotkey.enabled, "This will cause a leak and performance issues, AdeInputControl.ArcadeHotkey.Disable() has not been called.");
            Debug.Assert(!m_ArcadeInput.enabled, "This will cause a leak and performance issues, AdeInputControl.ArcadeInput.Disable() has not been called.");
        }
